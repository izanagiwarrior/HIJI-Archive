            ...
            <div class="row" style="height:inherit;">
                <div class="col-md-2 p-0" style="border-radius: 0 30px 30px 0;background-color:#232228;height:100%">
                    ...
                    <ul class="sidebar">
                        ...
                        <li class="text-white text-center"><b>{{Auth::user()->name}}</b></li>
                        <li class="sidebar-list"><a class="sidebar-anchor active" href="{{route('dashboard')}}">Dashboard</a></li>
                        <li class="sidebar-list"><a class="sidebar-anchor" href="{{route('product')}}">Product</a></li>
                        <li class="sidebar-list"><a class="sidebar-anchor" href="{{route('orderList')}}">Data</a></li>
